...
namespace EOQuiz
{
    public partial class profissional3 : Form
    {
        public profissional3()
        {
            InitializeComponent();
        }
         public profissional3(string core)
        {
        ...
        private void cry_Click(object sender, EventArgs e)
        {
            ...
            Player.Play();
            cry.Image = Properties.Resources.wgr;
            cry.Enabled = false;
        ...
        {
            this.Hide();
            profissional4 fon = new profissional4(label1.Text);
            fon.ShowDialog();
            this.Close();
        }
        ...
        private void play_Click(object sender, EventArgs e)
        {
            System.Media.SoundPlayer Player = new System.Media.SoundPlayer("som/errou.wav");
            Player.Play();
            play.Image = Properties.Resources.www;
            play.Enabled = false;
            if (core2.Visible == true)
            {
                if (core1.Visible == true)
        ...
        private void get_Click(object sender, EventArgs e)
        {
            System.Media.SoundPlayer Player = new System.Media.SoundPlayer("som/errou.wav");
            Player.Play();
            get.Image = Properties.Resources.wg;
            get.Enabled = false;
            if (core2.Visible == true)
            {
                if (core1.Visible == true)
