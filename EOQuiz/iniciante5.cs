...
namespace EOQuiz
{
    public partial class iniciante5 : Form
    {
        public iniciante5()
        {
            InitializeComponent();
        }
         public iniciante5(string core)
        {
        ...
        {
            this.Hide();
            iniciante6 fon = new iniciante6(label1.Text);
            fon.ShowDialog();
            this.Close();
        }
        ...
        private void corrida_Click(object sender, EventArgs e)
        {
            ...
            Player.Play();
            corrida.Image = Properties.Resources.morcego;
        ...
        private void basq_Click(object sender, EventArgs e)
        {
            System.Media.SoundPlayer Player = new System.Media.SoundPlayer("som/errou.wav");
            Player.Play();
            basq.Image = Properties.Resources.baleia;
            basq.Enabled = false;
            if (core2.Visible == true)
            {
                if (core1.Visible == true)
        ...
        private void golf_Click(object sender, EventArgs e)
        {
            System.Media.SoundPlayer Player = new System.Media.SoundPlayer("som/errou.wav");
            Player.Play();
            golf.Image = Properties.Resources.pin;
            golf.Enabled = false;
            if (core2.Visible == true)
            {
                if (core1.Visible == true)
