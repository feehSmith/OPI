...
namespace EOQuiz
{
    public partial class profissional5 : Form
    {
        public profissional5()
        {
            InitializeComponent();
        }
        public profissional5(string core)
        {
        ...
        private void cry_Click(object sender, EventArgs e)
        {
            ...
            Player.Play();
            cry.Image = Properties.Resources.boludor;
            cry.Enabled = false;
        ...
        {
            this.Hide();
            profissional6 fon = new profissional6(label1.Text);
            fon.ShowDialog();
            this.Close();
        }
        ...
        private void play_Click(object sender, EventArgs e)
        {
            System.Media.SoundPlayer Player = new System.Media.SoundPlayer("som/errou.wav");
            Player.Play();
            play.Image = Properties.Resources.brazur;
            play.Enabled = false;
            if (core2.Visible == true)
            {
                if (core1.Visible == true)
        ...
        private void get_Click(object sender, EventArgs e)
        {
            System.Media.SoundPlayer Player = new System.Media.SoundPlayer("som/errou.wav");
            Player.Play();
            get.Image = Properties.Resources.prar;
            get.Enabled = false;
            if (core2.Visible == true)
            {
                if (core1.Visible == true)
