...
namespace EOQuiz
{
    public partial class profissional8 : Form
    {
        public profissional8()
        {
            InitializeComponent();
        }
        public profissional8(string core)
        {
        ...
        private void und_Click(object sender, EventArgs e)
        {
            ...
            Player.Play();
            und.Image = Properties.Resources.marar;
            und.Enabled = false;
        ...
        private void cry_Click(object sender, EventArgs e)
        {
            System.Media.SoundPlayer Player = new System.Media.SoundPlayer("som/errou.wav");
            Player.Play();
            cry.Image = Properties.Resources.cunhar;
            cry.Enabled = false;
            if (core2.Visible == true)
            {
                if (core1.Visible == true)
        ...
        private void play_Click(object sender, EventArgs e)
        {
            System.Media.SoundPlayer Player = new System.Media.SoundPlayer("som/errou.wav");
            Player.Play();
            play.Image = Properties.Resources.temer;
           play.Enabled = false;
            if (core2.Visible == true)
            {
                if (core1.Visible == true)
        ...
        {
            this.Hide();
            profissional9 fon = new profissional9(label1.Text);
            fon.ShowDialog();
            this.Close();
        }
    }
